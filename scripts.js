    ...
    return (
      <div>
        ...
        <div className="author"> Designed and Coded By <br />
          <a target="_blank" href="https://codepen.io/sachinstiglitz"> 
            Sachin R Das
          </a>
        </div>
      </div>
...
// COMMENTS: 
// 1) Here, prevVal stores the result of the evaluation, if the result is operated on, this allows for the operation to be appended to the formula
// 2) Here, prevVal stores the formula as it was before the first operator is entered to allow for switching of operators before the next element is entered
